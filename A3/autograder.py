...
import grading
# import imp    # imp deprecated as of python 3.12. we now use importlib
import importlib  # importlib.import_module() to replace place of imp.import_module()
import optparse
import os
import re
import sys
...
def loadModuleFile(moduleName, filePath):
    # filepath was used back when this used the (now deprecated) imp library.
    # we still have the filePath argument because I am afraid to change the function signature
    # - CISC352 TA Zoey (2024)
